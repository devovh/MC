...
(@MENU_ID, 10, 3, 'Bow,Fist-Weapon,Thrown,Staff,Crossbow Trainer', 5, 16, 11866, 0, 0, 0, ''),
(@MENU_ID, 11, 3, 'Sword,Polearm,Dagger Trainer', 5, 16, 11867, 0, 0, 0, ''),
(@MENU_ID, 12, 3, 'Gun,Axe,Mace Trainer', 5, 16, 11865, 0, 0, 0, ''),
