...
local BAR_TEXTURE = "Interface\\Addons\\ArenaSpectator\\media\\BarTexture2"
...
local createAuraIcon = function(unit, framename, icons, index)
    ...
    overlay:SetTexture("Interface\\AddOns\\ArenaSpectator\\media\\border")
...
local function EventHandler(self, event, arg1, arg2, arg3, arg4)
    if (event == "PLAYER_LOGIN") then
        SendChatMessage(".spect version " .. GetAddOnMetadata("ArenaSpectator", "Version") or "0", "GUILD");
    end
...
function ASPEC_try_spectate(self, name, unit, server)
    SendChatMessage(".spect player " .. name, "GUILD");
end
